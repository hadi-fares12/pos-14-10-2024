...
async def add_user(
    ...
    try:
        ...
        data = await request.json()
        insert_query = f"INSERT INTO users(username, password, user_control, email, sales, sales_return, purshase, purshase_return, orders, trans, items, chart, statement, SAType, Branch, COH, EOD, RecallInv,TableUser,LockAfterDone,Pos,ManageItems,ManageGrpItems,InvHistory,DailySales,CashOnHands,Description,UnitPrice,EndshiftEod,EndShiftCOH) VALUES (%s, %s,,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        cursor.execute(insert_query, (user_name_uppercase, '', '', '', "N", "N", "N", "N", "N", "N", "N", "N", "N", "SA", '', user_name_uppercase, "N", "N","N", "N","N", "N","N", "N","N", "N","UPrice","1","Y", "Y"))
